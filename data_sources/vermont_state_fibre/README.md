...
- Query: [all fields and geometry, WGS84 GeoJSON](https://maps.vcgi.vermont.gov/arcgis/rest/services/PSD_services/OPENDATA_PSD_LAYERS_SP_NOCACHE_v1/MapServer/46/query?where=1%3D1&outFields=%2A&returnGeometry=true&f=geojson&outSR=4326)
...
```sh
curl -fsSL 'https://maps.vcgi.vermont.gov/arcgis/rest/services/PSD_services/OPENDATA_PSD_LAYERS_SP_NOCACHE_v1/MapServer/46/query?where=1%3D1&outFields=%2A&returnGeometry=true&f=geojson&outSR=4326' \
