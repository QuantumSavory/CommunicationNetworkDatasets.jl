...
- Source request: [data.gov.au WFS GeoJSON, EPSG:4326](https://data.gov.au/geoserver/fibre-optic-cable/wfs?request=GetFeature&typeName=ckan_fa5452e4_7713_4c15_b647_ba0191a8c25c&outputFormat=json)
...
```sh
curl -fsSL 'https://data.gov.au/geoserver/fibre-optic-cable/wfs?request=GetFeature&typeName=ckan_fa5452e4_7713_4c15_b647_ba0191a8c25c&outputFormat=json' \
...
result is approximate and is not suitable as a surveyed asset location. The WFS can serialize the
same live data differently between requests; extraction requires the retained response with the
pinned checksum above.
